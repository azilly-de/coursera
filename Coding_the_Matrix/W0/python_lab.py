...
## Task 19
L = ['A','B','C','D','E']
range_and_zip = list(zip(range(0,len(L)),L))
...
k = 'Bilbo'
value_list_modified_1 = [i[k] if k not in dlist else 'NOT PRESENT' for i in dlist] # <-- Use the same expression here
k = 'Frodo'
...
## Task 28
def cubes(L): return [x*x**2 for x in L]
